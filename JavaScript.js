...
! function (t, e) {
    ...
    function D(t, e) {
        if (x(t)) {
            ...
            for (var i = Object.keys(t), o = 0; o < i.length; o += 1)
                if (!1 === e.call(t[i[o]], i[o], t[i[o]])) return t; return t
    }
    ...
    bt.prototype.onScroll = function () {
        ...
        var t = this;
        this.isEnable || (this.isEnable = !0, this.state = "pinned", this.$element.addClass(this.options.initialClass).removeClass(this.options.pinnedClass).removeClass(this.options.unpinnedClass), this.lastScrollY = window.pageYOffset, yt.on("scroll", function () {
            return t.onScroll()
        }))
    }, bt.prototype.disable = function () {
        var t = this;
        this.isEnable && (this.isEnable = !1, this.$element.removeClass(this.options.initialClass).removeClass(this.options.pinnedClass).removeClass(this.options.unpinnedClass), yt.off("scroll", function () {
            return t.onScroll()
    ...
    L(function () {
        gt.on("input focus blur", ".mdui-textfield-input", {
            useCapture: !0
        }, qt), gt.on("click", ".mdui-textfield-expandable .mdui-textfield-icon", function () {
            L(this).parents(".mdui-textfield").addClass("mdui-textfield-expanded").find(".mdui-textfield-input")[0].focus()
        }), gt.on("click", ".mdui-textfield-expanded .mdui-textfield-close", function () {
    ...
    L(function () {
        ...
        }), gt.on(Rt, Ut, Bt), B.mutation(".mdui-slider", function () {
            Yt(L(this))
        })
    ...
    function Kt(t, e) {
        var n = this;
        void 0 === e && (e = {}), this.$element = L(), this.options = X({}, Gt), this.size = 0, this.$selected = L(), this.$menu = L(), this.$items = L(), this.selectedIndex = 0, this.selectedText = "", this.selectedValue = "", this.state = "closed", this.$native = L(t).first(), this.$native.hide(), X(this.options, e), this.uniqueID = L.guid(), this.handleUpdate(), gt.on("click touchstart", function (t) {
            var e = L(t.target);
    ...
    function Zt(t, e) {
        ...
        }), this.$tabs.length && -1 === this.activeIndex && (this.activeIndex = 0), this.setActive(), yt.on("resize", L.throttle(function () {
    ...
    ue.prototype.triggerEvent = function (t) {
        ...
        this.$element.hasClass("mdui-dialog-open") ? (this.state = "opened", this.triggerEvent("opened")) : (this.state = "closed", this.triggerEvent("closed"), this.$element.hide(), re(he).length || de || !fe || (L.unlockScreen(), fe = !1), yt.off("resize", L.throttle(this.readjust, 100)), this.options.destroyOnClosed && this.destroy())
    }, ue.prototype.doOpen = function () {
        var t = this;
        if (de = this, fe || (L.lockScreen(), fe = !0), this.$element.show(), this.readjust(), yt.on("resize", L.throttle(this.readjust, 100)), this.state = "opening", this.triggerEvent("open"), this.$element.addClass("mdui-dialog-open").transitionEnd(function () {
            return t.transitionEnd()
            ...
            var e = window.location.hash.substring(1); - 1 < e.indexOf("mdui-dialog") && (e = e.replace(/[&?]?mdui-dialog/g, "")), window.location.hash = e ? e + (-1 < e.indexOf("?") ? "&" : "?") + "mdui-dialog" : "mdui-dialog", yt.on("hashchange", this.hashchangeEvent)
        }
        ...
        void 0 === t && (t = !1), setTimeout(function () {
            ...
            }), e.options.history && !re(he).length && (t || window.history.back(), yt.off("hashchange", e.hashchangeEvent)), setTimeout(function () {
                ae(he)
            }, 100))
        })
    ...
    var ve = {
        ...
        ge = {
            ...
            closeOnEsc: !0,
            destroyOnClosed: !0,
            onOpen: function () {}, onOpened: function () {}, onClose: function () {}, onClosed: function () {}
        },
        ye = {
            confirmText: "ok",
            history: !0,
    ...
    Ce.prototype.isDisabled = function (t) {
        ...
        switch ("auto" === r && (r = n.top + n.height + i + s + 2 < yt.height() ? "bottom" : i + s + 2 < n.top ? "top" : i + o + 2 < n.left ? "left" : n.width + i + o + 2 < yt.width() - n.left ? "right" : "bottom"), r) {
        case "bottom":
    ...
    var ke = {
            ...
            onClick: function () {}, onButtonClick: function () {}, onOpen: function () {}, onOpened: function () {}, onClose: function () {}, onClosed: function () {}
        },
        _e = null,
        Te = "_mdui_snackbar";
    ...
    Oe.prototype.closeOnOutsideClick = function (t) {
        ...
        "opening" !== this.state && "opened" !== this.state && (_e ? re(Te, function () {
            ...
            }), e.options.closeOnOutsideClick && gt.on(jt, e.closeOnOutsideClick), e.options.timeout && (e.timeoutId = setTimeout(function () {
                return e.close()
            }, e.options.timeout)))
        })))
    }, Oe.prototype.close = function () {
        var t = this;
        "closing" !== this.state && "closed" !== this.state && (this.timeoutId && clearTimeout(this.timeoutId), this.options.closeOnOutsideClick && gt.off(jt, this.closeOnOutsideClick), this.state = "closing", this.options.onClose(this), this.setPosition("close"), this.$element.transitionEnd(function () {
    ...
    function je(t, e, n) {
        ...
        }), this.bindSubMenuEvent(), yt.on("resize", L.throttle(function () {
            return i.readjust()
        }, 100))
    }
    var Me = {
